...
// Get the modal
var swmedia_modal = document.getElementById("myswMediaModal");

// Get the button that opens the modal
var swmedia_btn = document.getElementById("myswMediaBtn");

// Get the <span> element that closes the modal
var swmedia_span = document.getElementsByClassName("swmedia_close")[0];

// When the user clicks the button, open the modal
swmedia_btn.onclick = function() {
	swmedia_modal.style.display = "block";
}

// When the user clicks on <span> (x), close the modal
swmedia_span.onclick = function() {
	swmedia_modal.style.display = "none";
}
