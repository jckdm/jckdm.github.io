...
// Get the modal
var bmedia_modal = document.getElementById("mybMediaModal");

// Get the button that opens the modal
var bmedia_btn = document.getElementById("mybMediaBtn");

// Get the <span> element that closes the modal
var bmedia_span = document.getElementsByClassName("bmedia_close")[0];

// When the user clicks the button, open the modal
bmedia_btn.onclick = function() {
	bmedia_modal.style.display = "block";
}

// When the user clicks on <span> (x), close the modal
bmedia_span.onclick = function() {
	bmedia_modal.style.display = "none";
}
